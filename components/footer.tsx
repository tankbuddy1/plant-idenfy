    ...
    <footer className="border-t">
      <div className="max-w-screen-xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-muted-foreground">
              Your trusted source for quality plants, expert care advice, and everything you need for a thriving garden.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-2 lg:grid-cols-4">
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2 text-sm text-muted-foreground">
                ...
                <Link className="hover:opacity-75" href="/careers">
                  Careers
                </Link>
              </nav>
            </div>
            ...
            <div>
              ...
              <nav className="mt-4 flex flex-col space-y-2 text-sm text-muted-foreground">
                <Link className="hover:opacity-75" href="/guides">
                  Plant Care Guides
                </Link>
                <Link className="hover:opacity-75" href="/library">
                  Plant Library
                </Link>
        ...
        <p className="mt-8 text-xs text-muted-foreground text-center">
          © {new Date().getFullYear()} Onlen Nursery. All rights reserved.
        </p>
      </div>
    </footer>
  )
